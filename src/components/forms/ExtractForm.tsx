  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const extractPayload = {
        ...
        amount_before_tax: formData.amount_before_tax !== undefined ? Number(formData.amount_before_tax) : 0,
        tax_amount: formData.tax_amount !== undefined ? Number(formData.tax_amount) : 0,
        ...
        percentage_completed: formData.percentage_completed !== undefined ? Number(formData.percentage_completed) : 0,
        current_amount: formData.current_amount !== undefined ? Number(formData.current_amount) : 0,
